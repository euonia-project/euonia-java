...
public record Quintet<V1, V2, V3, V4, V5>(V1 value1, V2 value2, V3 value3, V4 value4, V5 value5) implements Tuple {
     ...
     * @param <V4> 第四个值的类型
     * @param <V5> 第五个值的类型
     * @return 所有值均为 null 的新 Quintet 实例
     */
